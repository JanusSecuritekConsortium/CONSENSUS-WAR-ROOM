...
def test_runtime_bundle_includes_lifecycle_summary() -> None:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert "proposal_lifecycle_summary.json" in names
    finally:
...
if __name__ == "__main__":
    test_runtime_bundle_includes_lifecycle_summary()
    print("test_runtime_bundle_dossiers PASS")
