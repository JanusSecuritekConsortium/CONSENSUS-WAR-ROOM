...
THEME_GRAPHIC_ASSETS: Dict[str, ThemeGraphicAsset] = {
    "eva": ThemeGraphicAsset(
        ...
        "eva_boot",
        ("MAGI CUBE ARRAY", "CASPER", "BALTHASAR", "MELCHIOR", "XXXXXXXX"),
        expected_min_lines=18,
        expected_max_lines=18,
        expected_min_width=50,
        header_layout=HeaderLogoLayout(logo_font_size=6, logo_top_padding=10, logo_bottom_padding=10, logo_box_width=540, logo_box_scroll_enabled=False),
    ),
